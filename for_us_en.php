...
<div class="wrapper row4 bgded overlay" style="background-image:url('images/demo/backgrounds/black.jpg');">
    <footer id="footer" class="hoc clear">
        <h1>About us</h1>
        <p>We are students of Vlll V class of Vocational High School of Economics - Pernik. Our specialty is Economic Informatics and we decided to join the IT Olympics to showcase our knowledge and skills.</p>
        <hr>
        <br>
        <br>
        <br>
        <img src="images/map-marker.png" align="left" style="width:150px;height:150px;">
        <h1 class="tittle two">Where are we?</h1>
        <p>For more questions and contact with us, you can contact us via the contact form on our site!</p>
        <div class="contact-ad">
            <p>PGI - town of Pernik</p><p>
            </p><p>Address: Pernik, G. Mamarchev Str., 2</p><p>
            </p></div>
        <br>
